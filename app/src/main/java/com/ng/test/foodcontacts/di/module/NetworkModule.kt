...
import com.ng.test.foodcontacts.data.remote.RecipeService
import com.ng.test.foodcontacts.util.Memory
...
class NetworkModule {
    ...
    companion object {
        private const val RECIPE_API_URL = "https://www.themealdb.com/api/json/v1/1/"
    }
