...
import com.kotlin.mvvm.foodcontacts.databinding.FragmentHomeBinding
...
import com.kotlin.mvvm.foodcontacts.ui.main.base.BaseFragment
import com.kotlin.mvvm.foodcontacts.util.ext.hasPermission
...
//                intent.putExtra("recipe_data", Gson().toJson(it))
        ...
        when (requestCode) {
            PERMISSIONS_REQUEST_READ_CONTACTS -> {
                if ((grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED))
                    ...
                    Toast.makeText(context, "Your contacts won't be imported until you grant the permission. Please refresh to allow access to your contacts.", LENGTH_LONG).show()
                return
            }
            ...
            PERMISSIONS_REQUEST_MAKE_CALL -> {
                if ((grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED))
                    ...
                    Toast.makeText(context, "Please grant CALL Permission to enable calling from the app.", LENGTH_LONG).show()
                return
            }
        }
    }
